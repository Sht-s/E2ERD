...
# Nombre: Edgar Ruiz Diaz
# Este script utiliza etiquetas html para encontrar, dentro de las páginas deseadas del sitio web oficial de noticias de la UANL, cada una
# de las noticias que mencionan la facultad que el usuario especifica.
